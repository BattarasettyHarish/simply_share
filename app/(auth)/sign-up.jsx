...
const SignUp = () => {
  ...
  const submit = async () => {
    if (form.username === "" || form.email === "" || form.password === "") {
      ...
      return; // Added return to stop further execution if fields are empty
    }
      ...
      <ScrollView>
        ...
        >
          ...
          <FormField
            ...
            otherStyles="mt-10 border-white text-white placeholder-white border-0.5"  
          />
